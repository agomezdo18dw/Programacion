...
public class MainPersona {
	...
	public static void leerPersonas() {
		System.out.println("¿Cuantas personas quiere añadir?");
		...
		for (int i = 0; i < numPersonas; i++) {
			...
			System.out.print("Introduzca el codigo postal de la persona: ");
			int codigoPostal = scan.nextInt();
			scan.nextLine();
			System.out.print("Introduzca la ciudad en la que la persona vive: ");
		...
		System.out.println("Añadidas " + numPersonas + " correctamente.");
		System.out.println();
	}
